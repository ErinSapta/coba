...
<head>
    ...
    <title>Website Gallery Photo | Album</title>
...
<body>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>" class="btn btn-outline-danger">
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
    ...
    <p><strong>&copy; WEBSITE GALLERY PHOTO | ERIN SAPTA SAFITRI</strong></p>
    </footer>
